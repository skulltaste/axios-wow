...
Static HTML. Open a pull request into `main`. After merge, deploy the same files to whatever currently serves the domain (GitHub Pages and/or the Hostinger document root).
