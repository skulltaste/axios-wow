...
The lock lives in [GUILD.md](GUILD.md). That file is internal. Do not link it from the public page and do not deploy it to the live document root.

Public guild site for [axios-wow.com](https://axios-wow.com).

Axios is a Classic+ Alliance community. Large community with raid teams. Realm TBD.
